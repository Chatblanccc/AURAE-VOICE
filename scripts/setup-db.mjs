...
const DATABASE_URL = 'postgresql://neondb_owner:npg_CeMK7bXY3NwG@ep-lucky-mountain-a1z10jvf-pooler.ap-southeast-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require';
